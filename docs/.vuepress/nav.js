var EcosystemNav = [
    ...
    items: [
      {
        ...
        link: 'https://github.com/waihoyu/wai-ui'
      },
      {
        text: 'vue-admin-template',
        link: 'https://github.com/waihoyu/vue-admin-template'
      },
      {
        text: 'electron-vue-admin',
        link: 'https://github.com/waihoyu/electron-vue-admin'
      },
      {
      ...
      },
      {
        ...
        link: 'https://github.com/waihoyu/wai-ui/issues/2312'
      },
      {
        text: 'vue-countTo',
        link: 'https://github.com/waihoyu/vue-countTo'
      },
      {
        text: 'vue-split-pane',
        link: 'https://github.com/waihoyu/vue-split-pane'
      },
      {
        text: 'awesome-bookmarks',
        link: 'https://github.com/waihoyu/awesome-bookmarks',
        type: 'ZH'
      }
    ]
  },
  {
    ...
    items: [
      ...
      {
        textZH: '作者Blog',
        link: 'https://waihoyu.com/circles/1209',
        type: 'ZH'
      },
      {
        textZH: '常见问题',
      ...
      {
        textZH: 'QQ群',
        link: 'https://github.com/waihoyu/wai-ui/issues/602',
        type: 'ZH'
      },
      {
        textZH: '作者个人微博',
        link: 'https://weibo.com/u/7342549321',
        type: 'ZH'
      },
      {
        text: 'Changelog',
        ...
        textZH: '更新记录',
        link: 'https://github.com/waihoyu/wai-ui/releases'
      }
    ]
  }
]
